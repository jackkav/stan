...
with ({$: BigNumber, o: BigNumber.prototype}) {
  $.ROUND_HALF_EVEN =
    ($.ROUND_HALF_DOWN =
      ($.ROUND_HALF_UP = ($.ROUND_FLOOR = ($.ROUND_CEIL = ($.ROUND_DOWN = ($.ROUND_UP = 0) + 1) + 1) + 1) + 1) + 1) + 1
  $.defaultPrecision = 40
  ...
  o.add = function(n) {
    ...
    i =
      (la = a.length) == (lb = b.length) ? a.length : ((lb = la - lb) > 0 ? o._zeroes(b, lb) : o._zeroes(a, -lb)).length
  ...
  o.multiply = function(n) {
    ...
    return (
      (o._s = o._s != n._s),
      (o._f =
        ((r = la + lb - o._f - n._f) >= (j = (o._d = x._d).length) ? this._zeroes(o._d, r - j + 1, 1).length : j) - r),
      o.round()
    )
  }
  o.divide = function(n) {
          ...
          : r == $.UP
            ...
            : r == $.CEIL
              ...
              : r == $.FLOOR
                ...
                : r == $.HALF_UP
                  ? n >= 5
                  : r == $.HALF_DOWN ? n > 5 : r == $.HALF_EVEN ? n >= 5 && b[p - 1] & 1 : false) &&
        this.add(x)
